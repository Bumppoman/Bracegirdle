class Letters::CemeteryInspectionViolationsPDF < Letters::LetterPDF
  def letter_body
    ...
    text 'The administration of not-for-profit cemetery corporations is a time consuming, often thankless job.  We appreciate your acceptance of the responsibilities that go with the operation and maintenance of this not-for-profit cemetery.', indent_paragraphs: 34
  end
end