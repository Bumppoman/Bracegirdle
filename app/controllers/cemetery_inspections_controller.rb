  ...
  def cemetery_inspection_params
    params.require(:cemetery_inspection).permit(
      [
        ...
        :date_performed, :deeds_signed, :deeds_signed_comments, :directional_signs_comments, 
        :directional_signs_present, :directional_signs_required, :election, :employees, 
        :employees_comments, :fencing, :fencing_comments,
